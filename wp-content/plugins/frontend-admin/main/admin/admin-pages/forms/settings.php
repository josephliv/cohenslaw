...
class Frontend_Forms_UI
{
    ...
    function display_shortcode()
    {
        ...
        if ( 'admin_form' == $post->post_type ) {
            ...
            if ( !empty($post->post_name) ) {
                ...
                echo  '<button type="button" data-prefix="' . FEA_PREFIX . '" data-form="' . $post->post_name . '" class="copy-shortcode"> ', $icon_path, ' ' . __( 'Copy Code', FEA_NS ) . '</button>
		</div>' ;
            }
    ...
    function columns_content( $column, $post_id )
    {
        ...
        if ( 'shortcode' == $column ) {
            ...
            echo  '<button type="button" class="copy-shortcode" data-prefix="' . FEA_PREFIX . '" data-form="' . get_post_field( 'post_name', $post_id ) . '">', $icon_path, ' ' . __( 'Copy Code', FEA_NS ) . '</button>' ;
        }
