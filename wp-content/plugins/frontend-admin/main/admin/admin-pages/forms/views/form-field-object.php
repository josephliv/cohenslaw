	...
	<div class="handle">
		<ul class="acf-hl acf-tbody">
			<li class="li-field-order">
				<span class="acf-icon<?php if( $field['type'] != 'form_step' || $i > 0 ) echo ' acf-sortable-handle'; ?>" title="<?php _e( 'Drag to reorder', 'acf' ); ?>"><?php echo ( $i + 1 ); ?></span>
			</li>
		...
		<table class="acf-table">
			<tbody class="acf-field-settings">
				...
				acf_render_field_setting(
					...
					array(
						'label'        => __( 'Label', 'acf' ),
						'instructions' => __( 'This is the name which will appear on the frontend', FEA_NS ),
						'name'         => 'label',
						'type'         => 'text',
						'class'        => 'field-label',
					),
