    ...
    class Frontend_WP_Elementor
    {
        ...
        public function widget_categories( $elements_manager )
        {
            $categories = array(
                ...
                'title' => __( 'FRONTEND POSTS', FEA_NS ),
                'icon'  => 'fa fa-plug',
            ),
                'frontend-admin-users'      => array(
                'title' => __( 'FRONTEND USERS', FEA_NS ),
                'icon'  => 'fa fa-plug',
            ),
                'frontend-admin-taxonomies' => array(
                'title' => __( 'FRONTEND TAXONOMIES', FEA_NS ),
                'icon'  => 'fa fa-plug',
            ),
            );
        ...
        public function editor_scripts()
        {
            ...
            wp_enqueue_style(
                'fea-icon',
                FEA_URL . 'assets/css/icon.css',
                array(),
                FEA_VERSION
            );
            wp_enqueue_style(
                'fea-editor',
                FEA_URL . 'assets/css/editor' . $min . '.css',
                array(),
                FEA_VERSION
            );
            wp_enqueue_script(
                'fea-editor',
                FEA_URL . 'assets/js/editor' . $min . '.js',
