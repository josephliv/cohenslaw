...
class ContentTab
{
    ...
    public function fields_controls( $widget, $steps = true )
    {
        ...
        $widget->add_control( 'save_all_data', [
    ...
    public function register_step_controls( $repeater, $widget, $first = false )
    {
        $repeater->add_control( 'emails_to_send', [
            'label'       => __( 'Step Emails', FEA_NS ),
            'type'        => Controls_Manager::TEXT,
            'description' => __( 'A comma seperated list of email names to send upon completing this step.', FEA_NS ),
            'condition'   => [
            'field_type' => 'step',
        ],
        ] );
        ...
        /* $repeater->add_control(
        			'overwrite_settings',
        			[
        				'label' => __( 'Advanced Settings', FEA_NS ),
        				'type' => Controls_Manager::SWITCHER,
        				'label_on' => __( 'Yes', FEA_NS ),
        				'label_off' => __( 'No',FEA_NS ),
        				'return_value' => 'true',	
        ...
        /* 
        		...
        		$repeater->add_control(
        			...
        			[
        				'label' => __( 'Custom Permmissions Settings', FEA_NS ),
        				'type' => Controls_Manager::SWITCHER,
        				'label_on' => __( 'Yes', FEA_NS ),
        				'label_off' => __( 'No',FEA_NS ),
        				'return_value' => 'true',	
    ...
    {
        add_action( FEA_PREFIX . '/form_structure_section', [ $this, 'register_form_structure_section' ] );
