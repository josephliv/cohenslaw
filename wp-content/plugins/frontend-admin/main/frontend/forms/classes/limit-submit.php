...
class LimitSubmit{
	...
	public function subtract_add_record( $new_status, $old_status, $post ) {
		if ( $old_status == $new_status || did_action( 'acf_frontend/form/on_submit' ) ) return;
	...
	public function __construct() {
		add_filter( 'acf_frontend/show_form', array( $this, 'limit_form_render' ), 11 );
		add_action( 'acf_frontend/form/on_submit', array( $this, 'add_submission' ) );	
