...
<div class="hide-if-value">
		...
		<label class="acf-basic-uploader file-drop">
			...
			<div class="file-custom">
				<?php  _e('No ' .$field['field_type']. ' selected',FEA_NS); ?>
	...
	<?php else : ?>
		...
		<p><?php _e( 'No file selected', 'acf' ); ?> <a data-name="add" class="acf-button button" href="#"><?php echo $button_text; ?></a></p>
	...
	function upload_button_text_setting( $field ) {
		acf_render_field_setting( $field, array(
			...
			'name'			=> 'button_text',
			'type'			=> 'text',
			'placeholder'	=> __( 'Add Attachment', FEA_NS ),
		) );
	}
