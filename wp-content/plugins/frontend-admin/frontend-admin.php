 ...
 * Description: This awesome plugin allows you to easily display frontend admin forms on your site so your clients can easily edit content by themselves from the frontend.
 * Version:     3.3.37
...
if ( function_exists( 'fea_instance' ) ) {
    ...
    define( 'FEA_NS', 'frontend-admin' );
    define( 'FEA_PRO', 'https://frontendadmin.com/go-pro/' );
    define( 'FEA_PREFIX', 'frontend_admin' );
    define( 'FEA_PRE', 'frontend-admin' );
    ...
    function fea_instance()
    {
        ...
        if ( !isset( $fea_instance ) ) {
            if ( !defined( 'WP_FS__PRODUCT_6146_MULTISITE' ) ) {
                define( 'WP_FS__PRODUCT_6146_MULTISITE', true );
            }
    ...
    if ( !class_exists( 'Front_End_Admin' ) ) {
        ...
        final class Front_End_Admin
        {
            ...
            {
                return sprintf(
                    __( 'Hey %1$s' ) . ',<br>' . __( 'Welcome to %2$s! Opt in here to start receiving our essential onboarding email series, walking you through the best ways to use and benefit from our plugin. You’ll also be opting into feature update notifications and non-sensitive diagnostic tracking from our partner over at %3$s.', FEA_NS ),
                    $user_first_name,
                    '<b>' . $plugin_title . '</b>',
                    $freemius_link
                );
            ...
            function include_acf_plugin()
            {
                // Define path and URL to the ACF plugin.
                define( 'FEA_ACF_PATH', __DIR__ . '/includes/acf/' );
                define( 'FEA_ACF_URL', FEA_URL . '/includes/acf/' );
                // Include the ACF plugin.
                include_once FEA_ACF_PATH . 'acf.php';
            ...
            public function plugin_includes()
            {
                ...
                if ( did_action( 'elementor/loaded' ) ) {
                    ...
                    require_once __DIR__ . '/main/elementor/classes/migrate_settings.php';
                }
